...
スマホ版は提供された店内画像と透過テーブル素材を使用し、最大幅430pxの縦画面いっぱいに店内を表示します。コインと右上のノートに加え、従来の6項目の下部メニューを常時表示します。店内は下部メニューを除く領域いっぱいに表示します。素材の画像と稼働設備・人物・注文は独立しており、画像がない場合のCSSフォールバックも維持しています。
