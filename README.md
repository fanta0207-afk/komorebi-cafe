...
カフェは背景・家具・購入設備・テーブルと座席・客・恋愛対象キャラクター・吹き出し・演出の8レイヤーです。注文の吹き出しから調理・提供でき、詳細は「注文とキッチン」、設備・スタッフ・思い出・累計は「店のようす」から開きます。物語・所持品・v5セーブ形式を維持します。旧セーブに複数の調理中注文がある場合、残り時間と消費済み食材を保持し、順番に調理を再開します。
