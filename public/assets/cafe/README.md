...
- 下部メニュー（店・街・贈物・人物・スタッフ）を常時表示。「設備・料理」は画面上部のコイン表示の下のボタンや各設備をタップして開きます。右上のノートには注文ノート・店のようす・思い出をまとめています。店内は下部メニューに重ならない領域を使います。
...
- 3種類を4席で共用します。人物素材の差し替えによって注文・調理・提供・売上のルールは変えません。
