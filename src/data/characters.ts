...
export const characters: Character[] = [
  ...
  },
  {
    ...
    "voice": "「僕」と話す。尊大で命令口調が多く、相手の反応を楽しむように意地悪く笑う。本気の気持ちは独占欲の強いまっすぐな言葉になる。",
    ...
    "greetings": {
      "first": "僕がカカオ・ショコラ。……君、本当に僕のチョコを扱える舌を持ってるのか？",
      "familiar": "来たね。今日は逃がさないよ。新作を全部、君の言葉で評価して。",
      "close": "僕以外のチョコで満足しないで。……君の舌は、僕が一番知っていたい。",
      "romance": "遅い。君が来るまで、誰にも新作を食べさせなかった。責任を取って、僕の隣にいて。",
      "friendship": "君の店に出す一粒だ。遠慮はいらない、対等な職人として意見を聞かせて。"
    },
    "giftResponses": {
      "love": "へえ、僕の好みをここまで読んだんだ。合格。……特別に、すごくうれしいと言ってあげる。",
      "like": "悪くない選択だね。僕のそばに置く価値はある。ありがとう。",
      "normal": "僕に贈り物？　受け取っておくよ。次はもっと僕を驚かせて。",
      "dislike": "僕にこれを選ぶとはいい度胸だ。……でも、君が選んだ気持ちまで捨てたりはしない。"
    }
  }
];
