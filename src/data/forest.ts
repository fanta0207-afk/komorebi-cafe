...
export const forestRecipes: Recipe[] = [
    ...
    recipe('forestSecretTea', 'こもれび香草ティー', '🍵', 1700, 20, ['forestHerb', 'forestMint', 'teaLeaves'], 'coffeeCounter', ['tea', 'drink']),
    recipe('forestSecretCookie', '森くるみクッキー', '🍪', 1900, 20, ['forestWalnut', 'flour', 'sugar'], 'prepTable', ['sweet', 'dessert']),
    recipe('forestSecretMilk', '琥珀花蜜ミルク', '🥛', 2200, 20, ['forestHoney', 'milk'], 'coffeeCounter', ['milk', 'drink']),
    recipe('forestSecretPancake', '月しずくパンケーキ', '🥞', 2600, 30, ['forestMoonBerry', 'flour', 'egg', 'milk'], 'prepTable', ['sweet', 'dessert']),
];
...
export const forestAreas: ForestArea[] = [
    { id: 'clearing', name: 'こもれび広場', icon: '🌳', normal: { coffeeBeans: 30, bread: 30, strawberry: 20, herb: 10, sugar: 10 }, bonus: { forestBerry: 50, forestHerb: 30, forestPetal: 20 }, secret: 'forestBerrySoda' },
    { id: 'river', name: '川辺', icon: '🏞️', normal: { mint: 35, herb: 30, teaLeaves: 20, milk: 10, egg: 5 }, bonus: { forestMint: 50, forestHerb: 30, forestPetal: 20 }, secret: 'forestPetalTea' },
    ...
    { id: 'grove', name: '木立', icon: '🌲', normal: { flour: 30, bread: 25, tomato: 20, lettuce: 15, strawberry: 10 }, bonus: { forestWalnut: 50, forestMushroom: 30, forestBerry: 20 }, secret: 'forestMushroomToast' },
    ...
    { id: 'stone', name: '苔むす小道', icon: '🌿', normal: { chocolate: 30, sugar: 25, teaLeaves: 20, milk: 15, coffeeBeans: 10 }, bonus: { forestHoney: 40, forestMoonBerry: 20, forestPetal: 20, forestHerb: 20 }, secret: 'forestSecretMilk' },
    { id: 'spring', name: '月しずくの泉', icon: '✨', normal: { frozenBerries: 30, vanillaIce: 25, milk: 20, strawberry: 15, mint: 10 }, bonus: { forestMoonBerry: 45, forestHoney: 25, forestBerry: 15, forestMint: 15 }, secret: 'forestSecretPancake' },
];
