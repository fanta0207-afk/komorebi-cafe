...
export function GiftShopScreen() {
  ...
  return <section className="screen fade-in"><ScreenTitle kicker="PETIT MARKET" title="ミモザ雑貨店"><button className="refresh-button" disabled={state.actionsRemaining<=0} onClick={()=>refreshGiftShop(true)}>↻ 更新 <small>⚡1</small></button></ScreenTitle>
