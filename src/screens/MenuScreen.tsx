...
export function MenuScreen() {
  ...
  return <section className="screen fade-in"><ScreenTitle kicker="CAFE GROWTH" title="設備と料理"/><p className="intro-copy">設備を増やすと同時に作れる料理が増えます。強化すると、1段階ごとに調理時間が15%短くなります。</p>
